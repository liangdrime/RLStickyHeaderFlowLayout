...
SWIFT_CLASS("_TtC24RLStickyHeaderFlowLayout34RLStickyHeaderFlowLayoutAttributes")
@interface RLStickyHeaderFlowLayoutAttributes : UICollectionViewLayoutAttributes
...
@interface UICollectionViewLayoutAttributes (SWIFT_EXTENSION(RLStickyHeaderFlowLayout))
